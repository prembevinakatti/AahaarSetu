      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-indigo-100 pt-20 px-8">
        <div className="max-w-7xl mx-auto flex flex-col gap-8">
          <section className="bg-white border-l-4 border-indigo-600 rounded-lg px-6 py-4 shadow-sm">
            ...
            <p className="text-gray-600">Volunteer verification system</p>
          </section>
          ...
          <section className="grid grid-cols-3 gap-6">
            ...
            <StatCard
              ...
              value={pending.length + connected.length}
            />
          </section>
...
const VolunteerCard = ({
  ...
  <div className="border rounded-lg p-4 flex justify-between items-center">
    ...
    {connected && <p className="text-green-600 font-bold text-sm">Connected</p>}
  </div>
);
